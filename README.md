...
To produce the stats JSON file, version 5.8 (or higher) of OmegaT is necessary (soon to be released by available as of 2022-12-22 as a nightly build from the [official Github repo](github.com/omegat-org/omegat). 
